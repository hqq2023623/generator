 ...
 * @date 2018/1/15
 */
public class CustomJavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        fullEntity.append(context.getJavaClientGeneratorConfiguration().getTargetPackage());
        fullEntity.append(".");
