 ...
 *  limitations under the License.
 */
package org.mybatis.generator.custom.config.xml;
...
public class CustomMyBatisGeneratorConfigurationParser {
    ...
    protected void parseSqlMapGenerator(Context context, Node node) {
        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new CustomSqlMapGeneratorConfiguration();
    ...
    protected void parseJavaModelGenerator(Context context, Node node) {
        JavaModelGeneratorConfiguration javaModelGeneratorConfiguration = new CustomJavaModelGeneratorConfiguration();
    ...
    private void parseJavaClientGenerator(Context context, Node node) {
        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new CustomJavaClientGeneratorConfiguration();
